...
contract LiquidityProviderSampler is SamplerUtils, ApproximateBuys {
    ...
    function sampleSellsFromLiquidityProvider(
        ...
        for (uint256 i = 0; i < numSamples; i++) {
            try ILiquidityProvider(providerAddress).getSellQuote{gas: DEFAULT_CALL_GAS}(
                IERC20TokenV06(takerToken), IERC20TokenV06(makerToken), takerTokenAmounts[i]
    ...
    function _sampleSellForApproximateBuyFromLiquidityProvider(
        ...
        try this.sampleSellsFromLiquidityProvider{gas: DEFAULT_CALL_GAS}(
