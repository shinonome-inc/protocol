    ...
    function sampleSellsFromBalancerV2(
        ...
        for (uint256 i = 0; i < numSamples; i++) {
            ...
            try vault
                ...
                .queryBatchSwap(IBalancerV2Vault.SwapKind.GIVEN_IN, swapSteps, swapAssets, swapFunds)
    ...
    function sampleBuysFromBalancerV2(
        ...
        for (uint256 i = 0; i < numSamples; i++) {
            ...
            try vault
                ...
                .queryBatchSwap(IBalancerV2Vault.SwapKind.GIVEN_OUT, swapSteps, swapAssets, swapFunds) returns (
