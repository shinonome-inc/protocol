...
contract MooniswapSampler is SamplerUtils, ApproximateBuys {
    ...
    function sampleSellsFromMooniswap(
        ...
        for (uint256 i = 0; i < numSamples; i++) {
            uint256 buyAmount =
                sampleSingleSellFromMooniswapPool(registry, takerToken, makerToken, takerTokenAmounts[i]);
    ...
    function sampleSingleSellFromMooniswapPool(
        ...
        try pool.getReturn{gas: MOONISWAP_CALL_GAS}(mooniswapTakerToken, mooniswapMakerToken, takerTokenAmount)
